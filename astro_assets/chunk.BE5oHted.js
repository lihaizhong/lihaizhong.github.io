...
const __0_______assets_git_reset_png__ = new Proxy({"src":"/astro_assets/asset.DFfWSKoB.png","width":888,"height":658,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/lihaizhong/Documents/Project/lihaizhong.blog/src/assets/git-reset.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/lihaizhong/Documents/Project/lihaizhong.blog/src/assets/git-reset.png");
							return target[name];
						}
					});

const __1_______assets_git_revert_png__ = new Proxy({"src":"/astro_assets/asset.BHoVZKtL.png","width":706,"height":174,"format":"png"}, {
						get(target, name, receiver) {
							if (name === 'clone') {
								return structuredClone(target);
							}
							if (name === 'fsPath') {
								return "/Users/lihaizhong/Documents/Project/lihaizhong.blog/src/assets/git-revert.png";
							}
							if (target[name] !== undefined && globalThis.astroAsset) globalThis.astroAsset?.referencedImages.add("/Users/lihaizhong/Documents/Project/lihaizhong.blog/src/assets/git-revert.png");
							return target[name];
						}
					});
