...
const $$Header = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<header class="my-9"> <!-- <h2 class="mb-1 text-3xl font-bold">{SITE_TITLE}</h2> --> <nav class="mb-2"> ${renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/" }, { "default": ($$result2) => renderTemplate`首页` })} ${renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/blog" }, { "default": ($$result2) => renderTemplate`博客` })} ${renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/interview" }, { "default": ($$result2) => renderTemplate`面试题` })} ${renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": "/archive" }, { "default": ($$result2) => renderTemplate`归档` })} ${renderComponent($$result, "HeaderLink", $$HeaderLink, { "href": SOCIAL_GITHUB, "target": "_blank" }, { "default": ($$result2) => renderTemplate`GitHub` })} </nav> <p class="my-3 text-base text-gray-400">${SITE_DESCRIPTION}</p> </header>`;
